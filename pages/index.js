import LogoPotatoHead from "@/components/LogoPotatoHead"
            ...
            {process.env.NEXT_PUBLIC_BODY ? (
              <article
                ...
                dangerouslySetInnerHTML={{
                  __html: process.env.NEXT_PUBLIC_BODY,
                }}
              />
            ) : (
              <article className="prose prose-p:mt-0 prose-p:mb-2 text-xs lg:text-sm dark:prose-p:text-white dark:prose-a:text-white">
                <p>
                  We&apos;re doing some quick maintenance to improve your
                  browsing experience.
                </p>
                <p>
                  Don&apos;t worry, your transactions and account information
                  are safe and won&apos;t be affected.
                </p>
                <p>
                  We&apos;re sorry for any inconvenience and appreciate your
                  patience.
                </p>
                <p>&nbsp;</p>
                <p>Terima kasih!</p>
...
export async function getServerSideProps(context) {
  // Set 503 status code for maintenance mode
  // Note: Using getServerSideProps just for status code, page content is static
  context.res.statusCode = 503
  context.res.setHeader("Retry-After", "3600") // Suggest retry after 1 hour
